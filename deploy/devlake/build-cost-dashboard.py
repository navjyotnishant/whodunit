...
dashboard = {
    ...
    "templating": {"list": [
        ...
        {"name": "contributor", "type": "query", "datasource": "${datasource}",
         ...
         # substitutes a chosen value as {value} — which matches nothing,
         # so every panel empties the moment a contributor is picked,
         # while "All" keeps working because __all__ is compared
         # literally.
         "multi": False, "includeAll": True, "allValue": "__all__",
         "refresh": 1, "hide": 0},
    ]},
    "panels": panels,
}
