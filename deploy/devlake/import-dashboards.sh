...
main() {
	...
	for name in whodunit whodunit-adoption whodunit-cost whodunit-dora \
		whodunit-exec whodunit-hours whodunit-funnel whodunit-teams whodunit-mcp whodunit-productivity whodunit-board whodunit-leadership whodunit-teams-board; do
