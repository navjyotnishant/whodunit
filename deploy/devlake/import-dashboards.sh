...
main() {
	...
	for name in whodunit whodunit-adoption whodunit-cost whodunit-dora \
		whodunit-exec whodunit-hours whodunit-funnel whodunit-mcp whodunit-productivity whodunit-board whodunit-leadership whodunit-teams-board whodunit-mcp-board; do
